...
export function OfficeLayout3D() {
  ...
  return (
    <group>
      {/* === Zone Floor Colors (matched to 2D Living Office) === */}
      <ZoneFloor position={[3.5, 0.015, 2.8]} size={[6.5, 5]} color="#5cc8ff" />
      <ZoneFloor position={[12, 0.015, 2.8]} size={[6.5, 5]} color="#fbbf24" />
      <ZoneFloor position={[3.5, 0.015, 9]} size={[6.5, 5]} color="#34d399" />
      <ZoneFloor position={[12, 0.015, 9]} size={[6.5, 5]} color="#a78bfa" />

      {/* === Zone Labels (matched to 2D: 规划室/工具房/执行间/交付台) === */}
      <ZoneLabel position={[1.5, 0.05, 0.8]} label={t("zones.desk")} color="#5cc8ff" />
      <ZoneLabel position={[9.5, 0.05, 0.8]} label={t("zones.meeting")} color="#fbbf24" />
      <ZoneLabel position={[1.5, 0.05, 6.8]} label={t("zones.hotDesk")} color="#34d399" />
      <ZoneLabel position={[9.5, 0.05, 6.8]} label={t("zones.lounge")} color="#a78bfa" />
